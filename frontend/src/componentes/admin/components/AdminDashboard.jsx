/**
 * Componente AdminDashboarimport { useAdminHook } from "../../../hooks/useAdminHook";
 * 
...
import { useUsersStats, useSystemStats } from '@compartido/hooks/useAdminHook';

const AdminDashboard = ({ timePeriod = '30d' }) => {
  const [selectedMetric, setSelectedMetric] = useState('users');
  
  const { useGetAdminDashboard, useGetSystemStats } = useAdminHook();
      ...
      <div className="space-y-3">
        ...
        <button className="w-full flex items-center justify-between p-3 text-left rounded-lg hover:bg-gray-50 transition-colors">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium text-gray-900">Configurar Permisos</p>
              <p className="text-sm text-gray-600">Gestionar roles y accesos</p>
            </div>
          </div>
          <Eye className="w-4 h-4 text-gray-400" />
        </button>
        ...
        <button className="w-full flex items-center justify-between p-3 text-left rounded-lg hover:bg-gray-50 transition-colors">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Revisar auditoría del sistema</p>
            </div>
          </div>
          <Eye className="w-4 h-4 text-gray-400" />
        </button>
