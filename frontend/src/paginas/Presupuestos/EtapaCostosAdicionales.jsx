...
import { DollarSign, Truck, Wrench, Calculator, Droplets, Settings, AlertCircle, Info } from 'lucide-react';

const EtapaCostosAdicionales = ({ formData, updateFormData, errors = {} }) => {
  const [localData, setLocalData] = useState({
    ...
    apply_engineering: false,
    apply_metallic_inserts: false,
    apply_waterproofing: false,
    ...formData
  });
  ...
  const costItems = [
    {
      ...
      label: 'Transporte',
      icon: Truck,
      description: 'Costo de transporte y logística',
    ...
    },
    {
      ...
      label: 'Montaje',
      icon: Wrench,
      description: 'Costo de montaje e instalación',
      field: 'mounting_cost',
    ...
    },
    {
      ...
      label: 'Ingeniería',
      icon: Calculator,
      description: 'Costos de ingeniería y diseño',
      field: 'engineering_cost',
      applyField: 'apply_engineering',
      color: 'text-purple-600'
    },
    {
      key: 'metallic_inserts',
      label: 'Insertos Metálicos',
      icon: Settings,
      description: 'Costo de insertos y herrajes metálicos',
      field: 'metallic_inserts_cost',
      applyField: 'apply_metallic_inserts',
    ...
    },
    {
      ...
      icon: Droplets,
      description: 'Costo de impermeabilización y sellado',
      field: 'waterproofing_cost',
      applyField: 'apply_waterproofing',
      color: 'text-cyan-600'
    }
  ];
